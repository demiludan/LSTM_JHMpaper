...
#----------------------------------------------------------
# predicting streamflow for furture n_out time steps given meteorogical data at previous n_in time step.
...
# 1.3 ---define and fit LSTM model
model = Sequential()
model.add(LSTM(Nnode, input_shape=(train_X.shape[1], train_X.shape[2])))
